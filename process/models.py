...
class TipoLead(models.Model):
    ...
    class Meta:
        verbose_name = "1. Categoría"
        verbose_name_plural = "1. Categorías"
...
class Programa(models.Model):
    ...
    tipo_lead = models.ForeignKey(
        TipoLead, on_delete=models.CASCADE, verbose_name="Categoría"
    )
...
class Momento(models.Model):
    ...
    programa = models.ForeignKey(
        Programa, on_delete=models.CASCADE, verbose_name="Grupo"
    )
...
class Submomento(models.Model):
    id = models.AutoField(primary_key=True)
    nombre = models.CharField(max_length=100)
    momento = models.ForeignKey(Momento, on_delete=models.CASCADE, verbose_name="Item")

    def __str__(self):
        return f"{self.nombre} - {self.momento}"

    class Meta:
        verbose_name = "4. Subitem"
        verbose_name_plural = "4. Subitems"
...
class Respuesta(models.Model):
    ...
    submomento = models.ForeignKey(
        Submomento, on_delete=models.CASCADE, verbose_name="Subitem"
    )
...
class Documento(models.Model):
    ...
    class Meta:
        verbose_name = "6. Documento"
        verbose_name_plural = "6. Documentos"
